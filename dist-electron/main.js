...
const iconPath = path.join(__dirname$1, "..", "assets", "icon.png");
...
async function initDatabase() {
  const sqlJsPath = path.join(__dirname$1, "..", "node_modules", "sql.js", "dist");
...
function createWindow() {
  ...
  let bounds = { width: 1280, height: 800, x: void 0, y: void 0 };
  if (boundsJson) {
    try {
